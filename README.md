...
Create a currentBattles directory, and create a partyImages directory inside the website directory. Whenever a battle occurs in a channel you have permission to view, recommendations will be printed to the corresponding file in the currentBattles directory, looking something like this:
