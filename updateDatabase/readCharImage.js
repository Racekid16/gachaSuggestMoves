...
async function sendToServer(charName) {
    let images = document.getElementsByClassName('imageWrapper__178ee imageZoom__9528e clickable__2869d');
    let imageURL = images[images.length - 1].children[0].getAttribute('data-safe-src')
