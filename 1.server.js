...
function getNumStars(slotName, image) {
    ...
    switch(slotName) {
        case 'slot1':
            if (RGBA_difference(RGBA_at(81, 92, image), [244, 130, 124, 255]) > 50) {
                return 1;
            }
            if (RGBA_difference(RGBA_at(75, 92, image), [213, 80 , 123, 255]) > 50) {
                return 2;
            }
            if (RGBA_difference(RGBA_at(65, 93, image), [243, 141, 136, 255]) > 50) {
                return 3;
            }
            if (RGBA_difference(RGBA_at(59, 94, image), [219, 103, 104, 255]) > 50) {
                return 4;
            }
            return 5;
        case 'slot2':
